...
var (
	...
	ErrMissingGrant      = errors.New("attendance verification grant is missing")
	ErrInvalidGrant      = errors.New("attendance verification grant is invalid")
	ErrExpiredGrant      = errors.New("attendance verification grant is expired")
	ErrConsumedGrant     = errors.New("attendance verification grant is consumed")
