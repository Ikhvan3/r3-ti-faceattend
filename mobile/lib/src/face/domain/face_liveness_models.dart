...
class LivenessConfig {
  const LivenessConfig({
    this.openEyeThreshold = 0.65,
    this.closedEyeThreshold = 0.35,
    this.turnYawThreshold = 14,
    this.centerYawThreshold = 7,
    this.maxRollDegrees = 18,
    this.minFaceBoxRatio = 0.28,
    this.edgeMarginRatio = 0.08,
    this.actionTimeout = const Duration(seconds: 6),
    this.challengeTimeout = const Duration(seconds: 25),
    this.faceLostTimeout = const Duration(milliseconds: 900),
    this.multipleFaceGrace = const Duration(milliseconds: 700),
    this.trackingMismatchGrace = const Duration(milliseconds: 500),
    this.stabilizationDuration = const Duration(milliseconds: 800),
    this.actionStableDuration = const Duration(milliseconds: 250),
    this.noisyFrameGrace = const Duration(milliseconds: 300),
    this.frameThrottle = const Duration(milliseconds: 150),
