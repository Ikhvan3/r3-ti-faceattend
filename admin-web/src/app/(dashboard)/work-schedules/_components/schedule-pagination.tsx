...
export function SchedulePagination({
  ...
  query: ParsedWorkScheduleSearchParams | ParsedAssignmentSearchParams;
  totalPages: number;
  totalItems: number;
}) {
  ...
  const hrefFor = (page: number) =>
    kind === "schedule"
      ? workScheduleListHref(query as ParsedWorkScheduleSearchParams, page)
      : assignmentListHref(query as ParsedAssignmentSearchParams, page);
