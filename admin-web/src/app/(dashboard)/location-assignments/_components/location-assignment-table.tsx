...
import { formatDateOnly } from "@/lib/location/utils";

export function LocationAssignmentTable({
  assignments,
}: {
            ...
            {assignments.map((assignment) => (
              <tr className="align-top" key={assignment.id}>
                ...
                <td className="px-4 py-3 text-slate-700">
                  {assignment.office_location.name}
                </td>
                <td className="px-4 py-3 text-slate-700">
                ...
                <td className="px-4 py-3">
                  <Link
                    ...
                    href={`/location-assignments/${assignment.id}`}
                  >
                    Detail
                  </Link>
                </td>
