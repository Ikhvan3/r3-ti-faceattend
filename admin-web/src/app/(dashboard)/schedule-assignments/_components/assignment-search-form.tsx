...
import type { ParsedAssignmentSearchParams } from "@/lib/schedule/utils";
import { ASSIGNMENT_STATUSES, assignmentStatusLabel } from "@/lib/schedule/utils";

export function AssignmentSearchForm({
  query,
  employees,
  schedules,
}: {
  ...
  return (
    ...
    >
      ...
      <Field htmlFor="schedule_id" label="Jadwal">
        <select className={inputClassName} defaultValue={query.schedule_id} id="schedule_id" name="schedule_id">
      ...
      <div className="flex items-end">
        <Link className={secondaryLinkClassName} href="/schedule-assignments">
          Reset
        </Link>
      </div>
    </form>
