...
import type { ParsedOfficeLocationSearchParams } from "@/lib/location/utils";
import {
  OFFICE_LOCATION_STATUSES,
  officeLocationStatusLabel,
} from "@/lib/location/utils";

export function OfficeLocationSearchForm({
  query,
}: {
    ...
    >
      ...
      <div>
        ...
        >
          ...
          {OFFICE_LOCATION_STATUSES.map((status) => (
      ...
      <div className="flex items-end">
        <Link className={secondaryLinkClassName} href="/office-locations">
          Reset
        </Link>
      </div>
    </form>
